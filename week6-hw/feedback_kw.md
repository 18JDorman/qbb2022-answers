...
6. Script set up to convert sparse data into square matrix
  * what you have works, but you can do something without a for loop: `mat[data_filt["F1"] - start_bin, data_filt["F2"] - start_bin] = data_filt['score']` and this will fill in the whole `mat` array for each combo/row of F1, F2, and score values
...
2. Insulation script set up to (0.5 pts each)
  ...
  * convert sparse data into square matrix; --> oh you use the non-for loop approach here; very nice
